...
namespace SC
{
    namespace vulkan
    {
        ...
        void RenderPass::BeginRenderPass(int frameBufferIndex, VkExtent2D extent, VkCommandBuffer buffer)
        {
            VkRenderPassBeginInfo renderPassInfo{};
            renderPassInfo.sType = VK_STRUCTURE_TYPE_RENDER_PASS_BEGIN_INFO;
            renderPassInfo.renderPass = m_renderPass;
            renderPassInfo.framebuffer = m_framebuffers[frameBufferIndex]->GetHandle(); // m_swapchain->GetFramebuffer(imageIndex)->Get(); // m_swapChainFramebuffers[imageIndex];
        ...
        void RenderPass::EndRenderPass(VkCommandBuffer buffer)
        {
